        ...
        <div className="rounded-2xl overflow-hidden border border-gray-100 shadow-[0_20px_60px_-24px_rgba(0,0,0,0.12)] bg-white">
          <div className="p-8 md:p-12 lg:p-14 bg-linear-to-br from-white via-brand-bg to-amber-50/30">
            ...
            <div className="overflow-hidden text-[15px] md:text-base text-gray-600 font-light leading-relaxed">
              <figure className="mb-6 w-full rounded-xl overflow-hidden border border-gray-100/90 shadow-md bg-white">
                <Image
                  src={lobbyAboutImage}
        ...
        <div className="rounded-2xl border border-gray-100 bg-white shadow-[0_20px_60px_-24px_rgba(0,0,0,0.12)] overflow-hidden">
          ...
          <div className="space-y-10 p-8 md:p-12 lg:p-14">
            ...
            <div className="border-t border-gray-100 pt-2">
              <h3 className="mb-4 flex items-center gap-3 border-b border-gray-100 pb-4 font-serif text-xl text-brand-black md:text-2xl">
                <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-brand-gold/10 text-brand-gold" aria-hidden>
                  <svg className="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                </span>
            ...
            <div className="border-t border-gray-100 pt-2">
              <h3 className="mb-4 flex items-center gap-3 border-b border-gray-100 pb-4 font-serif text-xl text-brand-black md:text-2xl">
                <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-brand-gold/10 text-brand-gold" aria-hidden>
                  <svg className="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75" /></svg>
                </span>
                ...
                <ul className="space-y-2">
                  {STAY_DEPARTURE_BULLETS.map((key) => (
                    <li key={key} className="flex items-start gap-3 rounded-lg border border-brand-gold/15 bg-amber-50/60 px-4 py-2.5 text-sm">
                      <svg className="mt-0.5 size-4 shrink-0 text-brand-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2} aria-hidden><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                      {t(key)}
                    </li>
                  ))}
                </ul>
