...
export const servicesTranslations: Record<string, LangStrings> = {
  ...
  svcHeroTitle1: {
    eng: "We take care of every detail.",
    esp: "Nosotros cuidamos cada detalle.",
    ru: "Мы заботимся о каждой детали.",
    fr: "Nous prenons soin de chaque détail.",
    it: "Ci prendiamo cura di ogni dettaglio.",
    de: "Wir kümmern uns um jedes Detail.",
    uk: "Ми дбаємо про кожну деталь.",
    pl: "Dbamy o każdy detal.",
  },
  svcHeroTitle2: {
    eng: "All you have to do is enjoy Calpe.",
    esp: "Usted solo tiene que disfrutar de Calpe.",
    ru: "Вам остается только наслаждаться Кальпе.",
    fr: "Vous n'avez plus qu'à profiter de Calpe.",
    it: "Tu devi solo goderti Calpe.",
    de: "Sie müssen nur Calpe genießen.",
    uk: "Вам залишається тільки насолоджуватися Калпе.",
    pl: "Ty musisz tylko cieszyć się pobytem w Calpe.",
  },
  svcHeroDesc: {
    eng: "At INFTOUR, we prepare each apartment so that you feel comfortable from the moment you arrive and enjoy your stay as if you were at home.",
    esp: "En INFTOUR preparamos cada apartamento para que se sienta cómodo desde el primer momento y disfrute de su estancia como si estuviera en casa.",
    ru: "В INFTOUR мы подготавливаем каждую квартиру так, чтобы вы с самого начала чувствовали себя комфортно и наслаждались пребыванием, как дома.",
    fr: "Chez INFTOUR, nous préparons chaque appartement pour que vous vous sentiez à l'aise dès votre arrivée et que vous profitiez de votre séjour comme si vous étiez chez vous.",
    it: "Noi di INFTOUR prepariamo ogni appartamento affinché tu ti senta a tuo agio fin dal primo momento e ti godi il soggiorno come se fossi a casa tua.",
    de: "Bei INFTOUR bereiten wir jedes Apartment so vor, dass Sie sich vom ersten Moment an wohlfühlen und Ihren Aufenthalt wie zu Hause genießen können.",
    uk: "В INFTOUR ми готуємо кожну квартиру так, щоб ви з першого погляду відчули себе комфортно і насолоджувалися перебуванням, як вдома.",
    pl: "W INFTOUR przygotowujemy każdy apartament tak, abyś od pierwszej chwili czuł się komfortowo i cieszył się pobytem jak w domu.",
  },
  ...
  svcCardCleaningTitle: { eng: "Our services", esp: "Nuestros servicios", ru: "Наши услуги", fr: "Nos services", it: "I nostri servizi", de: "Unsere Dienstleistungen", uk: "Наші послуги", pl: "Nasze usługi" },
  svcCardCleaningDesc: {
    eng: "Information about the services included in your apartment and those available on request.",
    esp: "Información sobre los servicios incluidos en su apartamento y los disponibles bajo petición.",
    ru: "Информация об услугах, включенных в ваши апартаменты, и о доступных по запросу.",
    fr: "Informations sur les services inclus dans votre appartement et ceux disponibles sur demande.",
    it: "Informazioni sui servizi inclusi nel suo appartamento e su quelli disponibili su richiesta.",
    de: "Informationen zu den in Ihrem Apartment enthaltenen Dienstleistungen und den auf Anfrage verfügbaren Services.",
    uk: "Інформація про послуги, включені у ваші апартаменти, та про ті, що доступні на запит.",
    pl: "Informacje o usługach wliczonych w apartament oraz dostępnych na życzenie.",
  },
  svcCardOfficeTitle: { eng: "Send requests and comments", esp: "Enviar solicitud y comentarios", ru: "Отправить запрос и комментарии", fr: "Envoyer une demande et des commentaires", it: "Inviare richiesta e commenti", de: "Anfrage und Kommentare senden", uk: "Надіслати запит і коментарі", pl: "Wyślij prośbę i komentarze" },
  svcCardOfficeDesc: {
    eng: "Request services\nSuggest an idea",
    esp: "Solicitar servicios\nSugerir una idea",
    ru: "Запросить услуги\nПредложить идею",
    fr: "Demander des services\nSuggérer une idée",
    it: "Richiedere servizi\nSuggerire un'idea",
    de: "Dienstleistungen anfragen\nEine Idee vorschlagen",
    uk: "Запросити послуги\nЗапропонувати ідею",
    pl: "Poproś o usługi\nZaproponuj pomysł",
  },
  servicesIntro: {
