...
const translations: TranslationMap = {
  ...
  team1Name: { eng: "Alex García", esp: "Alex García", ru: "Алекс Гарсия" },
  team1Title: { eng: "Managing Director", esp: "Director general", ru: "Генеральный директор" },
  team2Name: { eng: "Maria López", esp: "María López", ru: "Мария Лопес" },
  team2Title: { eng: "Operations & Guest Experience", esp: "Operaciones y experiencia del huésped", ru: "Операции и работа с гостями" },
  team3Name: { eng: "Carlos Ruiz", esp: "Carlos Ruiz", ru: "Карлос Руис" },
  team3Title: { eng: "Property & Partnerships", esp: "Propiedades y alianzas", ru: "Недвижимость и партнёрства" },
  team4Name: { eng: "Elena Martínez", esp: "Elena Martínez", ru: "Елена Мартинес" },
  team4Title: { eng: "Marketing & Reservations", esp: "Marketing y reservas", ru: "Маркетинг и бронирования" },
  lobbyOfficeHeading: {
    eng: "Our office",
    esp: "Nuestra oficina",
    ru: "Наш офис",
  ...
  formEmailPlaceholder: { eng: "name@example.com", esp: "nombre@ejemplo.com", ru: "nombre@ejemplo.com" },
  ...
  formSubmit: { eng: "Send message", esp: "Enviar mensaje", ru: "Отправить сообщение" },
  formSendsTo: {
