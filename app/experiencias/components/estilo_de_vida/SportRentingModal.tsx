    ...
    icon: (
      ...
      >
        ...
        <path
          ...
          d="M6.5 17l4-8h3l4 8M9.8 10.5h4.4M14.2 10.5l-2.2-3h-2"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M12 3.5c-2.4 3-4.8 5.5-4.8 8.2a4.8 4.8 0 009.6 0c0-2.7-2.4-5.2-4.8-8.2z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M3 17c1.5-1.2 3-1.2 4.5 0s3 1.2 4.5 0s3-1.2 4.5 0s3 1.2 4.5 0"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M8 5.5l2.2 2h3.6l2.2-2 2 1.8-1.5 2.2v8H7.5v-8L6 7.3l2-1.8z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M10 7.5v10M14 7.5v10"
        />
      </svg>
    ),
  },
      ...
      >
        ...
        <div className="overflow-y-auto flex-1 px-8 py-6">
          <div className="bg-brand-bg border-b border-gray-200 -mx-8 px-8 pt-6 pb-6 mb-6 pr-14">
            ...
            <h3 id="sports-events-modal-title" className={MODAL_TITLE_CLASS}>
