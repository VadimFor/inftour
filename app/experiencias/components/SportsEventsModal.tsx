    ...
    icon: (
      ...
      >
        <path
          ...
          d="M16.5 6.75h-9a2.25 2.25 0 00-2.25 2.25v6a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25V9a2.25 2.25 0 00-2.25-2.25z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M9 3.75v3m6-3v3M9 17.25v3m6-3v3"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M3 7.5h18M4.5 7.5l1.5 12h12l1.5-12M9 11.25h6"
        />
      </svg>
    ),
  },
...
export default function SportsEventsModal({
  isOpen,
  onClose,
}: SportsEventsModalProps) {
