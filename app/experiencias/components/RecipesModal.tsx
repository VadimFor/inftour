...
import { recipesModalSectionsByLang } from "../translations/recipes_modal_sections";
                  ...
                  <div className="bg-white/80 border border-gray-200 rounded-sm px-4 py-3">
                    <ul className="space-y-1 text-sm text-gray-500">
                      {section.source.map((line, lineIndex) => (
                        <li key={`${sectionIndex}-source-${lineIndex}`} className="flex items-start gap-2">
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                          ...
                          <span className="leading-relaxed">{renderLabeledLine(line)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/80 border border-brand-gold/20 rounded-sm p-4">
                    ...
                    <ul className="space-y-1.5 text-sm text-gray-700">
                      {section.ingredients.map((line, lineIndex) => (
                        <li key={`${sectionIndex}-ing-${lineIndex}`} className="flex items-start gap-2">
                          <span
